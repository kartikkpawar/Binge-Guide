        ...
        <div className="w-3/5 px-5">
          ...
          <div className="flex">
            ...
            <div className="mt-12">
              ...
              <div className="mt-8 w-64 h-96 overflow-scroll hideScrollBar">
                {castData.cast.map((mem) => (
                  <div className="flex items-start ml-6 mb-5">
                    <img
                      src={`https://image.tmdb.org/t/p/original${mem.profile_path}`}
                      alt=""
                      className="h-28 rounded-md "
                    />
                    <div className="ml-4 flex-col flex w-full">
                      <span className="text-white text-sm font-md">
                        {mem.character}
                      </span>
